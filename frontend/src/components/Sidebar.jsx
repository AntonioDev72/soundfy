          ...
          {user ? (
            <>
              <button onClick={() => setShowProfile(true)}
                style={{ width: '100%', display: 'flex', alignItems: 'center', gap: 10, padding: '8px 16px', marginBottom: 8, borderRadius: 8, transition: 'background 0.15s', background: 'transparent' }}
                ...
                <span style={{ fontSize: 13, fontWeight: 600, flex: 1, textAlign: 'left', color: '#fff' }}>{user?.name}</span>
